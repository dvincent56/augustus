...
static const char *ini_keys[] = {
    ...
    [CONFIG_UI_EMPIRE_SMART_BORDER_PLACEMENT] = "ui_empire_smart_border_placement",
...
static int default_values[CONFIG_MAX_ENTRIES] = {
    ...
    [CONFIG_UI_EMPIRE_SMART_BORDER_PLACEMENT] = 1,
