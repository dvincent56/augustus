...
typedef enum {
    ...
    BUILDING_GODDESS_STATUE = 149,
    BUILDING_SENATOR_STATUE = 150,
    ...
    BUILDING_SHRINE_CERES = 194,
    BUILDING_SHRINE_NEPTUNE = 195,
    BUILDING_SHRINE_MERCURY = 196,
    BUILDING_SHRINE_MARS = 197,
    BUILDING_SHRINE_VENUS = 198,
    BUILDING_MENU_SHRINES = 199,
    BUILDING_MENU_GARDENS = 200,
    ...
    BUILDING_NATIVE_WELL = 211,
    BUILDING_NATIVE_MEETING_ALT = 212,
    BUILDING_NATIVE_HUT_ALT_2 = 213,
    BUILDING_NATIVE_MEETING_ALT_2 = 214,
    BUILDING_NATIVE_PALISADE = 215,
    // helper constants
    BUILDING_TYPE_MAX = 216
} building_type;
