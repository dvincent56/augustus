...
static const building_type MENU_BUILDING_TYPE[BUILD_MENU_MAX][BUILD_MENU_ITEM_MAX] = {
    ...
    {BUILDING_CLEAR_LAND, BUILDING_REPAIR_LAND, 0},
    {BUILDING_ROAD, BUILDING_HIGHWAY, BUILDING_ROADBLOCK, 0},
    {BUILDING_DRAGGABLE_RESERVOIR, BUILDING_AQUEDUCT, BUILDING_FOUNTAIN, BUILDING_WELL, 0},
    {BUILDING_BARBER, BUILDING_BATHHOUSE, BUILDING_DOCTOR, BUILDING_HOSPITAL, BUILDING_LATRINES, 0},
    ...
    {BUILDING_THEATER, BUILDING_AMPHITHEATER, BUILDING_ARENA, BUILDING_TAVERN, BUILDING_COLOSSEUM, BUILDING_HIPPODROME,
    ...
    {BUILDING_MENU_GARDENS, BUILDING_MENU_TREES, BUILDING_MENU_PATHS, BUILDING_MENU_PARKS, BUILDING_MENU_STATUES,
        BUILDING_MENU_GOV_RES, BUILDING_PLAZA, BUILDING_FORUM, BUILDING_SENATE, BUILDING_CITY_MINT,
    ...
    {BUILDING_ENGINEERS_POST, BUILDING_LOW_BRIDGE, BUILDING_SHIP_BRIDGE, BUILDING_SHIPYARD, BUILDING_DOCK,
        BUILDING_WHARF, BUILDING_WORKCAMP, BUILDING_ARCHITECT_GUILD, BUILDING_LIGHTHOUSE, BUILDING_TOLLHOUSE, 0},
    {BUILDING_PALISADE, BUILDING_WATCHTOWER, BUILDING_WALL, BUILDING_TOWER, BUILDING_GATEHOUSE, BUILDING_PREFECTURE,
        BUILDING_MENU_FORT, BUILDING_BARRACKS, BUILDING_MESS_HALL, BUILDING_ARMOURY, BUILDING_MILITARY_ACADEMY, 0},
    {BUILDING_MENU_FARMS, BUILDING_MENU_RAW_MATERIALS, BUILDING_MENU_WORKSHOPS,
        BUILDING_MARKET, BUILDING_GRANARY, BUILDING_WAREHOUSE, BUILDING_DEPOT, BUILDING_CARAVANSERAI, 0},
    ...
    {BUILDING_COLONNADE, BUILDING_HEDGE_LIGHT, BUILDING_HEDGE_DARK, BUILDING_LOOPED_GARDEN_WALL, BUILDING_ROOFED_GARDEN_WALL,
        BUILDING_PANELLED_GARDEN_WALL, BUILDING_PAVILION_BLUE, BUILDING_SMALL_POND, BUILDING_LARGE_POND, 0},
...
static const building_type BUILD_MENU_TYPE_TO_BUILDING_TYPE[BUILD_MENU_MAX] = {
    ...
    [BUILD_MENU_FORTS] = BUILDING_MENU_FORT,
