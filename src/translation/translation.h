...
typedef enum {
    ...
    TR_BUILDING_ODEON,
    TR_BUILDING_ODEON_DESC,
    TR_BUILDING_ODEON_DESC_NO_LABORS,
    TR_BUILDING_ODEON_REPRESENTATION,
    TR_TOOLTIP_OVERLAY_ODEON,
    TR_WINDOW_ADVISOR_ENTERTAINMENT_ODEON_COVERAGE,
    TR_FIGURE_TYPE_SINGER,
	TRANSLATION_MAX_KEY
} translation_key;
