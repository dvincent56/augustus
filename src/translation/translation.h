...
typedef enum {
    ...
    TR_CONFIG_HEADER_WATER_STRUCTURE_RANGE,
    ...
    TR_CONFIG_NOT_ACCEPTING_MARKETS,
    TR_CONFIG_HOUSES_DONT_EXPAND_INTO_GARDENS,
    TR_CONFIG_GP_CH_AUTO_CLEAR_TREES,
    ...
    TR_BUILDING_CARAVANSERAI_FOOD_SHORTAGE,
    ...
    TR_BUILDING_LIGHTHOUSE_NO_TIMBER,
    ...
    TR_WARNING_OPEN_WATER_NEEDED_FOR_BUILDING,
    ...
    TR_BUILDING_BOTH_MAUSOLEUM_DESC,
    TR_FIGURE_TYPE_WATCHMAN,
    TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION,
    ...
    TR_CITY_WARNING_WORKCAMP_NEEDED,
    TR_CITY_WARNING_BUILD_WORKCAMP,
    ...
    TR_SAVE_DIALOG_FILE_DOES_NOT_EXIST_TITLE,
    TR_SAVE_DIALOG_FILE_DOES_NOT_EXIST_TEXT,
    ...
    TR_BUILDING_CITY_MINT_PHASE_2,
    TR_BUILDING_CITY_MINT_PHASE_1_TEXT,
    TR_BUILDING_CITY_MINT_PHASE_2_TEXT,
    ...
    TR_BUILDING_HIGHWAY_STATION,
    TR_BUILDING_HIGHWAY_STATION_DESC,
    TR_BUILDING_HIGHWAY_STATION_NO_EMPLOYEES,
    TR_BUILDING_HIGHWAY_STATION_NO_RESOURCES,
    TR_BUILDING_HIGHWAY_STATION_FUNCTIONAL,
    TR_BUILDING_HIGHWAY_STATION_NOT_FUNCTIONAL,
    TR_BUILDING_HIGHWAY_STATION_MONTHLY_NEED,
    TR_BUILDING_HIGHWAY_STATION_HIGHWAY_TILES,
    TR_BUILDING_HIGHWAY_STATION_STONE_STOCK,
    TR_BUILDING_HIGHWAY_STATION_SAND_STOCK,
    TR_TOOLTIP_BUTTON_HIGHWAY_STATION,
    TR_WARNING_HIGHWAY_STATION_NEEDS_SENATE,
    ...
    TR_CHEAT_CASTED_CURSE,
    TR_CHEAT_BUILDINGS_INVINCIBLE,
    TR_CHEAT_CLIMATE_CHANGE,
    TR_CHEAT_EDITOR_WARNING_TITLE,
    TR_CHEAT_EDITOR_WARNING_TEXT,
    ...
    TR_EDITOR_EMPIRE_TOOL,
    TR_EDITOR_CURRENT_COORDS,
    TR_EDITOR_SELECTED_COORDS,
    TR_EDITOR_MAX_WAGES,
    TR_EDITOR_MIN_WAGES,
    TR_EDITOR_REPEAT,
    TR_EDITOR_DO_NOT_REPEAT,
    TR_EDITOR_REPEAT_FOREVER,
    TR_EDITOR_REPEAT_ONCE,
    TR_EDITOR_REPEAT_TWICE,
    TR_EDITOR_REPEAT_TEXT,
    TR_EDITOR_REPEAT_TIMES,
    TR_EDITOR_REPEAT_TIMES2,
    TR_EDITOR_REPEAT_FREQUENCY,
    TR_EDITOR_REPEAT_FREQUENCY2,
    TR_EDITOR_REPEAT_FREQUENCY_YEARS,
    TR_EDITOR_REPEAT_FREQUENCY_YEARS2,
    TR_EDITOR_REPEAT_FREQUENCY_MONTHS,
    ...
    TR_EDITOR_SCENARIO_EVENTS_GROUPS_EXPLANATION_TOOLTIP,
    TR_EDITOR_SCENARIO_EVENTS_DELETE_SELECTED_CONFIRM_TITLE,
    TR_EDITOR_SCENARIO_EVENTS_DELETE_SELECTED_CONFIRM_TEXT,
    ...
    TR_EDITOR_SCENARIO_EVENT_NAME,
    TR_EDITOR_SCENARIO_CONDITION,
    TR_EDITOR_SCENARIO_ACTION,
    TR_EDITOR_SCENARIO_NO_CONDITIONS,
    TR_EDITOR_SCENARIO_NO_ACTIONS,
    TR_EDITOR_SCENARIO_EVENTS_ADD,
    TR_EDITOR_SCENARIO_CONDITION_ADD,
    TR_EDITOR_SCENARIO_ACTION_ADD,
    TR_EDITOR_SCENARIO_SELECT_CONDITION,
    TR_EDITOR_SCENARIO_SELECT_ACTION,
    TR_EDITOR_DELETE,
    TR_EDITOR_DELETED,
    ...
    TR_EDITOR_CUSTOM_VARIABLES_ID,
    TR_EDITOR_CUSTOM_VARIABLES_NAME,
    TR_EDITOR_CUSTOM_VARIABLES_VALUE,
    TR_EDITOR_CUSTOM_VARIABLES_NEW,
    TR_EDITOR_CUSTOM_VARIABLE_UNABLE_TO_SET_NAME_TITLE,
    TR_EDITOR_CUSTOM_VARIABLE_UNABLE_TO_SET_NAME_TEXT,
    TR_EDITOR_CUSTOM_VARIABLE_UNABLE_TO_CHANGE_TITLE,
    TR_EDITOR_CUSTOM_VARIABLE_UNABLE_TO_CHANGE_TEXT,
    TR_EDITOR_CUSTOM_VARIABLE_UNABLE_TO_CHANGE_EVENT_ID,
    TR_EDITOR_CUSTOM_VARIABLES_IN_USE,
    TR_EDITOR_UNABLE_TO_LOAD_CUSTOM_MESSAGES_TITLE,
    TR_EDITOR_SCENARIO_SELECT_INTRO,
    TR_EDITOR_SCENARIO_DESELECT_INTRO,
    TR_EDITOR_SCENARIO_SELECT_VICTORY,
    TR_EDITOR_SCENARIO_DESELECT_VICTORY,
    TR_EDITOR_SCENARIO_BUILDING_NATIVE_HUT_ALT,
    ...
    TR_PARAMETER_TYPE_GOD,
    TR_PARAMETER_TYPE_CLIMATE,
    TR_PARAMETER_TYPE_REQUEST,
    ...
    TR_ACTION_TYPE_CAUSE_BLESSING,
    TR_ACTION_TYPE_CAUSE_MINOR_CURSE,
    TR_ACTION_TYPE_CAUSE_MAJOR_CURSE,
    TR_ACTION_TYPE_CHANGE_CLIMATE,
    TR_ACTION_TYPE_CHANGE_TERRAIN,
    TR_ACTION_TYPE_CHANGE_MODEL_DATA,
    ...
    TR_PARAMETER_VALUE_BUILDING_SMALL_TEMPLE_CERES, // temple names group start (dont change order)
    ...
    TR_PARAMETER_VALUE_BUILDING_LARGE_TEMPLE_VENUS, //temple names group end
    ...
    TR_PARAMETER_VALUE_MEDIA_TYPE_SPEECH,
    TR_PARAMETER_VALUE_MEDIA_TYPE_BACKGROUND_IMAGE,
    ...
    TR_PARAMETER_VALUE_GOD_CERES,
    TR_PARAMETER_VALUE_GOD_MARS,
    TR_PARAMETER_VALUE_GOD_MERCURY,
    TR_PARAMETER_VALUE_GOD_NEPTUNE,
    TR_PARAMETER_VALUE_GOD_VENUS,
    TR_PARAMETER_VALUE_CLIMATE_CENTRAL,
    TR_PARAMETER_VALUE_CLIMATE_NORTHERN,
    TR_PARAMETER_VALUE_CLIMATE_DESERT,
    ...
    TR_TOOLTIP_BUTTON_ROADBLOCK_ORDER_REJECT_ALL,
    TR_FIGURE_TYPE_BEGGAR,
    TR_BUILDING_ARMOURY,
    TR_BUILDING_ARMOURY_DESC,
    TR_BUILDING_ARMOURY_NO_EMPLOYEES,
    TR_BUILDING_ARMOURY_SOME_EMPLOYEES,
    TR_BUILDING_ARMOURY_MANY_EMPLOYEES,
    TR_BUILDING_TAVERN_DESC_UPGRADED_WINE_NO_FOOD,
    TR_BUILDING_TAVERN_DESC_UPGRADED_WINE_AND_FOOD,
    TR_BUILDING_AMPHITHEATER_DESC_UPGRADED_BOTH_SHOWS,
    TR_BUILDING_AMPHITHEATER_DESC_UPGRADED_NO_GLADIATORS,
    TR_BUILDING_AMPHITHEATER_DESC_UPGRADED_NO_ACTORS,
    TR_BUILDING_AMPHITHEATER_DESC_UPGRADED_NO_SHOWS,
    ...
    TR_BUILDING_ARENA_DESC_UPGRADED_NO_SHOWS,
    TR_MAIN_MENU_SELECT_CAMPAIGN,
    TR_WINDOW_SELECT_CAMPAIGN,
    TR_WINDOW_CAMPAIGN_AUTHOR,
    TR_WINDOW_CAMPAIGN_NO_DESC,
    TR_WINDOW_ORIGINAL_CAMPAIGN_NAME,
    TR_WINDOW_ORIGINAL_CAMPAIGN_DESC,
    TR_WINDOW_INVALID_CAMPAIGN_TITLE,
    TR_WINDOW_INVALID_CAMPAIGN_TEXT,
    TR_WINDOW_CAMPAIGN_MISSION_FAILED_TO_LOAD_TITLE,
    TR_WINDOW_CAMPAIGN_MISSION_FAILED_TO_LOAD_TEXT,
    TR_WINDOW_CAMPAIGN_BUTTON_BEGIN_CAMPAIGN,
    TR_WINDOW_CAMPAIGN_BUTTON_MISSION_LIST,
    TR_WINDOW_CAMPAIGN_CURRENT_MISSION,
    TR_WINDOW_CAMPAIGN_FINISHED,
    TR_WINDOW_MISSION_LIST_CAMPAIGN_NOT_FINISHED,
    TR_WINDOW_MISSION_LIST_BUTTON_BEGIN_SCENARIO,
    TR_WINDOW_MISSION_LIST_BUTTON_SCENARIO_SELECTION,
    TR_WINDOW_MISSION_LIST_SCENARIOS,
    ...
    TR_CONFIG_SHOW_DESIRABILITY_RANGE_ALL,
    TR_TOOLTIP_BUTTON_STORAGE_ORDER_ACCEPT_ALL,
    TR_TOOLTIP_BUTTON_STORAGE_ORDER_REJECT_ALL,
    ...
    TR_TOOLTIP_BUTTON_ACCEPT_MARKET_LADIES, // permissions tooltip group start (don't change order of these)
    TR_TOOLTIP_BUTTON_REJECT_MARKET_LADIES,
    TR_TOOLTIP_BUTTON_ACCEPT_TRADE_CARAVAN,
    TR_TOOLTIP_BUTTON_REJECT_TRADE_CARAVAN,
    TR_TOOLTIP_BUTTON_ACCEPT_TRADE_SHIPS,
    TR_TOOLTIP_BUTTON_REJECT_TRADE_SHIPS,
    TR_TOOLTIP_BUTTON_ACCEPT_QUARTERMASTER,
    TR_TOOLTIP_BUTTON_REJECT_QUARTERMASTER,
    TR_TOOLTIP_BUTTON_ACCEPT_WORKERS,
    TR_TOOLTIP_BUTTON_REJECT_WORKERS,
    TR_TOOLTIP_BUTTON_ACCEPT_BARKEEP,
    TR_TOOLTIP_BUTTON_REJECT_BARKEEP,
    TR_TOOLTIP_BUTTON_ACCEPT_CARAVANSERAI,
    TR_TOOLTIP_BUTTON_REJECT_CARAVANSERAI,
    TR_TOOLTIP_BUTTON_ACCEPT_LIGHTHOUSE,
    TR_TOOLTIP_BUTTON_REJECT_LIGHTHOUSE,
    TR_TOOLTIP_BUTTON_ACCEPT_ARMOURY,
    TR_TOOLTIP_BUTTON_REJECT_ARMOURY,
    TR_TOOLTIP_BUTTON_ACCEPT_WORKCAMP,
    TR_TOOLTIP_BUTTON_REJECT_WORKCAMP,
    TR_TOOLTIP_BUTTON_ACCEPT_NATIVES,
    TR_TOOLTIP_BUTTON_REJECT_NATIVES,
    TR_TOOLTIP_BUTTON_ACCEPT_CAESAR,
    TR_TOOLTIP_BUTTON_REJECT_CAESAR, // permissions tooltip group end (don't change order of these)
    TR_BUILDING_FORT_LEGIONARIES,
    TR_WINDOW_ADVISOR_LEGIONARIES,
    TR_BUILDING_FORT_MOUNTED,
    TR_WINDOW_ADVISOR_MOUNTED,
    TR_BUILDING_FORT_JAVELIN,
    TR_WINDOW_ADVISOR_JAVELIN,
    TR_WARNING_NO_ARMOURY,
    TR_CONFIG_USER_PATH_DEFAULT,
    TR_CONFIG_USER_PATH_WITH_SUBDIRECTORIES,
    TR_CONFIG_USER_PATH_RECOMMENDED,
    TR_CONFIG_USER_PATH_CUSTOM,
    TR_USER_DIRECTORIES_NOT_SET_UP_TITLE,
    TR_USER_DIRECTORIES_NOT_SET_UP_TEXT,
    TR_USER_DIRECTORIES_CANCELLED_TITLE,
    ...
    TR_USER_DIRECTORIES_WINDOW_USER_PATH,
    ...
    TR_EDITOR_REQUEST_DATE,
    TR_EDITOR_REQUEST_RESOURCE,
    TR_EDITOR_REQUEST_AMOUNT,
    TR_EDITOR_REQUEST_DEADLINE,
    TR_EDITOR_REQUEST_FAVOR_GAINED,
    TR_EDITOR_INVASION,
    TR_EDITOR_INVASIONS,
    ...
    TR_EDITOR_NEW_DEMAND_CHANGE,
    TR_EDITOR_NO_DEMAND_CHANGES,
    TR_EDITOR_NO_ROUTES,
    TR_EDITOR_UNKNOWN_ROUTE,
    TR_EDITOR_SET_A_ROUTE,
    TR_EDITOR_NO_PRICE_CHANGES,
    TR_EDITOR_NEW_PRICE_CHANGE,
    TR_TOOLTIP_BUTTON_DELETE_COMMON_MESSAGES,
    TR_EDITOR_FORM_ERRORS_FOUND,
    TR_EDITOR_FORM_HAS_FOLLOWING_ERRORS,
    TR_EDITOR_EDIT_REQUEST_NO_RESOURCE,
    TR_EDITOR_EDIT_REQUEST_NO_AMOUNT,
    TR_EDITOR_EDIT_REQUEST_SET_DEADLINE,
    TR_EDITOR_EDIT_INVASION_NO_TYPE,
    TR_EDITOR_EDIT_INVASION_NO_SOLDIERS,
    TR_EDITOR_EDIT_INVASION_SET_YEAR,
    TR_EDITOR_EDIT_DEMAND_CHANGE_NO_YEAR,
    TR_EDITOR_EDIT_DEMAND_CHANGE_INVALID_ROUTE_SET,
    TR_EDITOR_ALLOWED_BUILDINGS_ALLOWED,
    ...
    TR_BUILDING_LATRINES_UNNECESSARY,
    TR_BUILDING_LATRINES_NO_HOUSES,
    TR_CONFIG_DRAW_ASCLEPIUS,
    TR_BUILDING_NATIVE_HUT_ALT,
    TR_CONFIG_WAREHOUSES_GRANARIES_OVER_ROAD_PLACEMENT,
    TR_CONFIG_HIGHLIGHT_SELECTED_BUILDING,
    TR_CHEAT_UNLOCK_LEGIONS,
    ...
    TR_WINDOW_BUILDING_DISTRIBUTION_MAINTAINING,
    TR_CONFIG_MAX_AUTOSAVE_SLOTS,
    TR_FIX_KOREAN_BUILDING_DOCTORS_CLINIC,
    TR_FIX_GERMAN_CITY_RETAKEN,
    TR_TOOLTIP_PERSONAL_SAVINGS,
    TR_BUILDING_NATIVE_DECORATION,
    TR_BUILDING_NATIVE_MONUMENT,
    TR_BUILDING_NATIVE_WATCHTOWER,
    TR_BUILDING_NATIVE_DECORATION_DESC,
    TR_BUILDING_NATIVE_MONUMENT_DESC,
    TR_BUILDING_NATIVE_WATCHTOWER_DESC,
    TR_CONFIG_MOVE_SAVINGS_TO_THE_RIGHT,
    ...
    TR_TOOLTIP_BUILDING_DISTRIBUTION_MAINTAINING,
    TR_CONFIG_STORAGE_STEP_4,
    TR_TOOLTIP_DEPOT_MOVED,
    TR_TOOLTIP_DEPOT_ORDER_TO,
    TR_TOOLTIP_RIGHT_CLICK_TO_DECREASE,
    TR_TOOLTIP_POPULATION_GOAL,
    TR_CONFIG_PATRICIAN_DEVOLUTION_FIX,
    TR_PARAMETER_TERRAIN,
    TR_PARAMETER_ADD,
    TR_PARAMETER_TERRAIN_TREE,
    TR_PARAMETER_TERRAIN_ROCK,
    TR_PARAMETER_TERRAIN_WATER,
    TR_PARAMETER_TERRAIN_MEADOW,
    TR_PARAMETER_TERRAIN_SHRUB,
    TR_CONDITION_TEXT_TIME_LEFT_UNTIL_DEFEAT,
    TR_CONDITION_TEXT_TIME_LEFT_UNTIL_VICTORY,
    TR_CHEAT_DISABLE_INVASIONS,
    TR_CHEAT_DISABLE_LEGIONS_CONSUMPTION,
    TR_TOOLTIP_BUTTON_ACCEPT_ALL,
    TR_TOOLTIP_BUTTON_REJECT_ALL,
    TR_TOOLTIP_OVERLAY_PROBLEMS_NO_ROAD_ACCESS,
    TR_WARNING_NO_WAREHOUSE_TOWER_ROAD_ACCESS,
    TR_EDITOR_EARTHQUAKE_CUSTOM,
    TR_EDITOR_TOOL_EARTHQUAKE_POINT,
    TR_EDITOR_TOOL_EARTHQUAKE_CUSTOM,
    TR_EDITOR_TOOL_EARTHQUAKE_REMOVE,
    TR_PARAMETER_MODEL,
    TR_PARAMETER_DATA_TYPE,
    TR_PARAMETER_COST,
    TR_PARAMETER_DESIRABILITY_VALUE,
    TR_PARAMETER_DESIRABILITY_STEP,
    TR_PARAMETER_DESIRABILITY_STEP_SIZE,
    TR_PARAMETER_DESIRABILITY_RANGE,
    ...
    TR_PARAMETER_VALUE_BUILDING_MENU_FORTS,
    TR_EMPIRE_SIDE_BAR_SORT,
    ...
    TR_TOOLTIP_CHANGE_SIDEBAR_WIDTH,
    TR_TOOLTIP_ASCENDING_ORDER,
    TR_TOOLTIP_DESCENDING_ORDER,
    TR_CHEAT_CHANGE_WEATHER,
    TR_CONFIG_DEFAULT_GAME_SPEED,
    ...
    TR_EDITOR_CUSTOM_VARIABLES_TEXT_DISPLAY,
    TR_EDITOR_CUSTOM_VARIABLES_IS_VISIBLE,
    TR_ACTION_TYPE_CHANGE_CUSTOM_VARIABLE_VISIBILITY,
    TR_CONFIG_SHOW_CUSTOM_VARIABLES,
    TR_EDITOR_MODEL_DATA_DES_VALUE,    // Order is important
    TR_EDITOR_MODEL_DATA_DES_STEP,     //
    TR_EDITOR_MODEL_DATA_DES_STEP_SIZE,//
    TR_EDITOR_MODEL_DATA_DES_RANGE,    //
    TR_CONFIG_ENABLE_GETTING_WHILE_STOCKPILED,
    TR_CONFIG_ENABLE_PAVED_ROADS_NEAR_GRANARIES,
    TR_CONFIG_UI_ANIMATE_TRADE_ROUTES,
    TR_HOTKEY_NEXT_TRACK,
    TR_CONFIG_MOVE_LEGION_SOUND_SWAP,
    TR_BUILDING_INFO_REPAIR_BUILDING,
    TR_WARNING_REPAIR_IMPOSSIBLE,
    TR_WARNING_REPAIR_BURNING,
    TR_BUILDING_INFO_BUILDING_BURNING,
    TR_BUILDING_LAND_REPAIR,
    TR_BUILDING_LAND_CLEAR,
    TR_CONFIRM_REPAIR_BUILDINGS,
    TR_CONFIRM_REPAIR_BUILDINGS_TITLE,
    TR_CONFIG_ADVANCED_CART_DEPOT_OPTIONS,
    TR_BUILDING_INFO_INSTRUCTIONS,
    TR_BUILDING_INFO_ACTIVE_STORAGE_BUILDINGS,
    ...
    TR_CONFIG_GP_CH_STORAGE_REQUESTS_RESPECT_MAINTAIN,
    TR_CONFIG_ENABLE_MARKET_RANGE,
    TR_PARAMETER_TYPE_FORMULA,
    TR_CONDITION_TYPE_CHECK_FORMULA,
    ...
    TR_WARNING_CANT_REPAIR_MONUMENTS,
    TR_WARNING_CANT_REPAIR_AQUEDUCTS,
    TR_OVERLAY_HOUSING_TENTS,
    TR_OVERLAY_HOUSING_SHACKS,
    TR_OVERLAY_HOUSING_HOVELS,
    TR_OVERLAY_HOUSING_CASAS,
    TR_OVERLAY_HOUSE_INSULAS,
    TR_OVERLAY_HOUSE_VILLAS,
    TR_OVERLAY_HOUSE_PALACES,
    TR_OVERLAY_BY_GROUP,
    TR_EDITOR_PARAMETER_CITY_PROPERTY,
    TR_PARAMETER_PERCENTAGE,
    TR_PARAMETER_ABSOLUTE,
    TR_DECENNIUM_0,
    TR_DECENNIUM_1,
    TR_DECENNIUM_2,
    TR_DECENNIUM_3,
    ...
    TR_DECENNIUM_8,
    TR_DECENNIUM_9,
    TR_EDITOR_ACTION_TYPE_CITY_PROPERTY,
    TR_CITY_PROPERTY_NONE,
    TR_CITY_PROPERTY_DIFFICULTY,
    TR_CITY_PROPERTY_MONEY,
    TR_CITY_PROPERTY_POPULATION,
    TR_CITY_PROPERTY_SAVINGS,
    TR_CITY_PROPERTY_YEAR_FINANCE_BALANCE,
    TR_CITY_PROPERTY_RESOURCE_STOCK,
    TR_CITY_PROPERTY_STATS_FAVOR,
    TR_CITY_PROPERTY_STATS_PROSPERITY,
    TR_CITY_PROPERTY_STATS_CULTURE,
    TR_CITY_PROPERTY_STATS_PEACE,
    TR_CITY_PROPERTY_STATS_CITY_HEALTH,
    TR_CITY_PROPERTY_SERVICE_COVERAGE,
    TR_CITY_PROPERTY_POPS_UNEMPLOYMENT,
    TR_CITY_PROPERTY_POPS_HOUSING_TYPE,
    TR_CITY_PROPERTY_POPS_BY_AGE,
    TR_CITY_PROPERTY_ROME_WAGES,
    TR_CITY_PROPERTY_CITY_WAGES,
    TR_CITY_PROPERTY_BUILDING_COUNT,
    TR_CITY_PROPERTY_TROOPS_COUNT_PLAYER,
    TR_CITY_PROPERTY_TROOPS_COUNT_ENEMY,
    TR_CITY_PROPERTY_TERRAIN_COUNT_TILES,
    TR_CITY_PROPERTY_TROOPS_MELEE,
    TR_CITY_PROPERTY_TROOPS_RANGED,
    TR_CITY_PROPERTY_TROOPS_MOUNTED,
    TR_CITY_PROPERTY_ALL,
    TR_CITY_PROPERTY_ACTIVE_ONLY,
    TR_CITY_PROPERTY_COVERAGE_THEATRE,
    TR_CITY_PROPERTY_COVERAGE_ARENA,
    TR_CITY_PROPERTY_COVERAGE_AMPHITHEATRE,
    TR_CITY_PROPERTY_COVERAGE_TAVERN,
    TR_CITY_PROPERTY_COVERAGE_COLOSSEUM,
    TR_CITY_PROPERTY_COVERAGE_HIPPODROME,
    TR_CITY_PROPERTY_COVERAGE_BATHS,
    TR_CITY_PROPERTY_COVERAGE_DOCTOR,
    TR_CITY_PROPERTY_COVERAGE_BARBER,
    TR_CITY_PROPERTY_COVERAGE_HOSPITAL,
    TR_CITY_PROPERTY_COVERAGE_SCHOOL,
    TR_CITY_PROPERTY_COVERAGE_LIBRARY,
    TR_CITY_PROPERTY_COVERAGE_ACADEMY,
    TR_CITY_PROPERTY_CHOOSE_PROPERTY,
    TR_CITY_PROPERTY_QUOTA_FILL,
    TR_BUTTON_INFO_RETURN_ALL_LEGIONS,
    TR_WARNING_DEPOT_RECALL_ALL,
    TR_WARNING_DEPOT_RESOURCE_CHANGE,
    ...
    TR_WINDOW_BUILDING_DEPOT_CART_PUSHER_DELIVER,
    TR_WINDOW_BUILDING_DEPOT_CART_PUSHER_WAIT,
    TR_TOOLTIP_DEPOT_CLEAR_SRC,
    TR_TOOLTIP_DEPOT_CLEAR_DST,
    TR_EDITOR_BUYS,
    TR_EDITOR_SELLS,
    TR_EDITOR_ALL_BUYS,
    TR_EDITOR_ALL_SELLS,
    TR_ACTION_TYPE_WIN,
    TR_ACTION_TYPE_LOSE,
    TR_ACTION_TYPE_GOD_SENTIMENT,
    TR_ACTION_TYPE_POP_SENTIMENT,
    TR_MESSAGE_PROMOTE_RANK_PREFIX,
    TR_MESSAGE_DEMOTE_RANK_PREFIX,
    TR_MESSAGE_PROMOTE_RANK_SUFFIX,
    TR_MESSAGE_DEMOTE_RANK_SUFFIX,
    TR_ACTION_TYPE_CHANGE_RANK,
    TR_PARAMETER_TYPE_RANK,
    TR_CITY_MESSAGE_TITLE_GOVERNOR_RANK_CHANGE,
    TR_RANK_PROMOTE, // rank names group start (don't change order of these)
    TR_RANK_DEMOTE,
    TR_RANK_CITIZEN,
    TR_RANK_CLERK,
    TR_RANK_ENGINEER,
    ...
    TR_CONFIG_UI_WT_ENABLE_SNOW_CENTRAL,
    TR_EDITOR_UNABLE_TO_LOAD_MODEL_DATA_TITLE,
    TR_EDITOR_MODEL_DATA_IMPORT_FULL,
    TR_EDITOR_MODEL_DATA_EXPORT_FULL,
    TR_EDITOR_COLOR_LABEL,
    TR_EDITOR_COLOR_NONE, // label colors group start (don't change order of these)
    ...
    TR_EDITOR_RUBBLE,
    TR_PARAMETER_GRID_OFFSET_CORNER1,
    TR_PARAMETER_GRID_OFFSET_CORNER2,
    TR_CONDITION_TYPE_TERRAIN_IN_AREA,
    TR_CONFIG_UI_CV_CURSOR_SHADOW,
    TR_EDITOR_MODEL_PRODUCTION,
    TR_ACTION_TYPE_PRODUCTION_RATE,
    TR_EDITOR_EARTHQUAKE_RIGHT_TO_LEFT,
    TR_EDITOR_EARTHQUAKE_RANDOM,
    TR_EDITOR_EARTHQUAKE_RANDOM_RIGHT_TO_LEFT,
    TR_EDITOR_DESIRABILITY_VALUE,    // Order is important
    TR_EDITOR_DESIRABILITY_STEP,     //
    TR_EDITOR_DESIRABILITY_STEP_SIZE,//
    TR_EDITOR_DESIRABILITY_RANGE,    //
    TR_EDITOR_EARTHQUAKE_PATTERN,
    TR_CONFIG_GENERAL_UNLOCK_MOUSE,
    TR_CONFIG_GP_CH_HOUSING_PRE_MERGE_VACANT_LOTS,
    TR_EDITOR_EARTHQUAKE_CUSTOM_SET,
    TR_BUILDING_HOUSE_SMALL_TENT,
    TR_BUILDING_HOUSE_LARGE_TENT,
    TR_BUILDING_HOUSE_SMALL_SHACK,
    TR_BUILDING_HOUSE_LARGE_SHACK,
    TR_BUILDING_HOUSE_SMALL_HOVEL,
    TR_BUILDING_HOUSE_LARGE_HOVEL,
    TR_BUILDING_HOUSE_SMALL_CASA,
    TR_BUILDING_HOUSE_LARGE_CASA,
    TR_BUILDING_HOUSE_SMALL_INSULA,
    TR_BUILDING_HOUSE_MEDIUM_INSULA,
    TR_BUILDING_HOUSE_LARGE_INSULA,
    TR_BUILDING_HOUSE_GRAND_INSULA,
    TR_BUILDING_HOUSE_SMALL_VILLA,
    TR_BUILDING_HOUSE_MEDIUM_VILLA,
    TR_BUILDING_HOUSE_LARGE_VILLA,
    TR_BUILDING_HOUSE_GRAND_VILLA,
    TR_BUILDING_HOUSE_SMALL_PALACE,
    TR_BUILDING_HOUSE_MEDIUM_PALACE,
    ...
    TR_EMPIRE_TOOL_SELECT,
    TR_HOTKEY_EDITOR_EMPIRE_DELETE_OBJECT,
    TR_PARAMETER_BUYING,
    TR_EDITOR_DEMAND_CHANGE_BUYS,
    TR_EDITOR_DEMAND_CHANGE_SELLS,
    TR_EDITOR_VIEW_CURRENT_EMPIRE,
    TR_EDITOR_CREATE_NEW_EMPIRE,
    TR_CONFIG_UI_EMPIRE_SMART_BORDER_PLACEMENT,
    TR_CONFIG_CATEGORY_UI_EMPIRE,
    TR_EDITOR_CUSTOM_EMPIRE_TITLE_SAVE,
    TR_EDITOR_EMPIRE_EXPORT,
    TR_EDITOR_EMPIRE_IMPORT,
    TR_CONFIG_ENABLE_BUILD_MENU_SHORTCUTS,
    TR_EDITOR_CURRENT_ICON,
    TR_EMPIRE_CITY_ICON_DEFAULT,        // order is important
    ...
    TR_ACTION_TYPE_LOCK_TRADE_ROUTE,
    TR_PARAMETER_LOCK,
    TR_PARAMETER_UNLOCK,
    TR_EMPIRE_DELETE_OBJECT,
    ...
    TR_EMPIRE_EDGE_INDEX,
    TR_EMPIRE_WAYPOINT_INDEX,
    TR_EMPIRE_ROUTE_PARENT,
    ...
    TR_EMPIRE_BATTLE_PARENT,
    TR_EDITOR_EMPIRE_PROPERTIES,
    TR_EDITOR_IMAGE_IMPORT,
    TR_EDITOR_UNABLE_TO_SET_EMPIRE_IMAGE,
    TR_EDITOR_IMAGE_TO_SMALL,
    TR_EDITOR_IMAGE_TO_SMALL_EXPLANATION,
    ...
    TR_EMPIRE_TOOLTIP_EDIT_NAME,
    TR_EMPIRE_TOOLTIP_ADD_RESOURCE,
    TR_EMPIRE_TOOLTIP_ROUTE_TYPE,
    TR_EMPIRE_TOOLTIP_AFTER_ICON,
    TR_EMPIRE_TOOL_PICK,
    TR_EMPIRE_TOOLTIP_SHOW_TOOLS,
    TR_EMPIRE_TOOLTIP_ROUTE_COST,
    TR_RESOURCE_SETTINGS_IN_GRANARIES,
    TR_CONFIG_HEADER_RAIN,
    TR_CONFIG_HEADER_SNOW,
    TR_CONFIG_HEADER_SAND,
    TR_CONFIG_HEADER_EMPIRE_EDITOR,
    TR_CONFIG_UI_WT_PREVIEW_RAIN,
    TR_CONFIG_UI_WT_PREVIEW_SNOW,
    TR_CONFIG_UI_WT_PREVIEW_SANDSTORM,
    TR_CONFIG_UI_WT_PREVIEW_HEAVY_RAIN,
    TR_CONFIG_WT_RAIN_INTENSITY,
    TR_CONFIG_WT_RAIN_SPEED,
    TR_CONFIG_WT_RAIN_LENGTH,
    TR_CONFIG_WT_SNOW_INTENSITY,
    TR_CONFIG_WT_SNOW_SPEED,
    TR_CONFIG_WT_SANDSTORM_INTENSITY,
    TR_CONFIG_WT_SANDSTORM_SPEED,
    TR_CONFIG_WT_SANDSTORM_SIZE,
    TR_CONFIG_WT_SNOWFLAKE_SIZE,
    TR_CONFIG_WT_SIZE_MINIMUM,
    TR_CONFIG_WT_SIZE_SMALL,
    TR_CONFIG_WT_SIZE_REGULAR,
    TR_CONFIG_WT_SIZE_LARGE,
    TR_CONFIG_WT_SIZE_MAXIMUM,
    TR_CONFIG_WT_SPEED_SLOW,
    TR_CONFIG_WT_SPEED_FAST,
    TR_CONFIG_WT_WEATHER_DURATION,
    TR_CONFIG_WT_DURATION_SHORT,
    TR_CONFIG_WT_DURATION_REGULAR,
    TR_CONFIG_WT_DURATION_LONG,
    TR_ADVISOR_HEALTH_WATER_COVERAGE,
    TR_ADVISOR_HEALTH_HEALTH_COVERAGE,
    TR_BUILDING_FOUNTAINS,
    TR_BUILDING_WELLS,
    TR_BUILDING_LATRINE,
    TR_ADVISOR_CHIEF_WATER_COVERAGE,
    TR_ADVISOR_CHIEF_CLEAN_WATER,
    TR_ADVISOR_CHIEF_LATRINE_AND_WELL,
    TR_ADVISOR_CHIEF_WELL_WATER,
    TR_ADVISOR_CHIEF_NO_WATER,
    TR_TOOLTIP_OVERLAY_PROBLEMS_DEPOT_NO_INSTRUCTIONS,
    TR_CONFIG_GRANARY_DEFAULT_TO_PASS_ALL_WALKERS,
    TR_CONFIG_WAREHOUSE_DEFAULT_TO_PASS_ALL_WALKERS,
    TR_EDITOR_SCENARIO_CHANGE_MODEL_DATA,
    TR_EDITOR_PRICE_CHANGE,
    TR_EDITOR_PRICE_CHANGES,
    TR_EDITOR_DEMAND_CHANGE,
    TR_EDITOR_DEMAND_CHANGES,
    TR_FIGURE_TYPE_PLEBIAN,
    TR_CONFIG_GP_CH_HOUSING_DO_NOT_SPAWN_PLEBIANS,
    TR_DESTRIBUTION_SOURCE,
    TR_DESTRIBUTION_DESTINATION,
    TR_BUILDING_DEPOTS,
    TR_FIGURE_TYPE_DOG,
    TR_CONFIG_GP_CH_HOUSING_DO_NOT_SPAWN_DOGS,
    TR_CONFIG_HEADER_DESIRABILITY,
    TR_CONFIG_SHOW_SHORELINE_DESIRABILITY,
    TR_CONFIG_SHOW_ELEVATION_DESIRABILITY,
    TR_BUILDING_TRIUMPHAL_ARCH_PHASE_1,
    TR_BUILDING_TRIUMPHAL_ARCH_PHASE_2,
    TR_BUILDING_TRIUMPHAL_ARCH_PHASE_1_TEXT,
    TR_BUILDING_TRIUMPHAL_ARCH_PHASE_2_TEXT,
    TR_BUILDING_TRIUMPHAL_ARCH_CONSTRUCTION_DESC,
    TR_CITY_MESSAGE_TITLE_TRIUMPHAL_ARCH_COMPLETE,
    TR_CITY_MESSAGE_TEXT_TRIUMPHAL_ARCH_COMPLETE,
    TR_BUILDING_TRIUMPHAL_ARCH_SUPPLIED_BY_ROME,
    TR_EDITOR_TOOL_MARSHLAND,
    TR_EDITOR_TOOL_WATER,
    TR_TERRAIN_MARSHLAND,
    TR_TERRAIN_MARSHLAND_DESC,
    TRANSLATION_MAX_KEY
} translation_key;
