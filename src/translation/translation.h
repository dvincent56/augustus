...
typedef enum {
    ...
    TR_BUILDING_TOLLHOUSE,
    TR_BUILDING_TOLLHOUSE_DESC,
    TR_BUILDING_TOLLHOUSE_NO_EMPLOYEES,
    TR_BUILDING_TOLLHOUSE_NO_RESOURCES,
    TR_BUILDING_TOLLHOUSE_FUNCTIONAL,
    TR_BUILDING_TOLLHOUSE_NOT_FUNCTIONAL,
    TR_BUILDING_TOLLHOUSE_MONTHLY_NEED,
    TR_BUILDING_TOLLHOUSE_STONE_STOCK,
    TR_BUILDING_TOLLHOUSE_SAND_STOCK,
    TR_TOOLTIP_BUTTON_TOLLHOUSE,
    TR_WARNING_TOLLHOUSE_NEEDS_SENATE,
