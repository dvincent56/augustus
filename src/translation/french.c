...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_GRAND_TEMPLE_CONSTRUCTION_DESC, "Bâtir un temple monumental requiert des matériaux stockés dans un entrepôt, des ouvriers d'un chantier, et des architectes de la guilde homonyme."},
    ...
    {TR_BUILDING_CARAVANSERAI_PHASE_1_TEXT, "Les ingénieurs établissent les fondations d'une grande cour où les marchands pourront se rassembler."},
    ...
    {TR_BUILDING_LIGHTHOUSE_PHASE_4_TEXT, "Les ingénieurs apportent la touche finale au Phare. Bientôt, il brillera sur des kilomètres, guidant les navires à bon port."},
    {TR_BUILDING_LIGHTHOUSE_CONSTRUCTION_DESC, "Bâtir un Phare requiert des matériaux stockés dans un entrepôt, des ouvriers d'un chantier, et des architectes de la guilde homonyme."},
    ...
    {TR_BUILDING_SMALL_TEMPLE_CONSTRUCTION_DESC, "Bâtir ce temple requiert des matériaux d'un entrepôt, des ouvriers d'un chantier, et des architectes de la guilde homonyme." },
    ...
    {TR_BUILDING_LARGE_MAUSOLEUM_PHASE_2_TEXT, "Des artisans talentueux préparent la façade du mausolée, la parant de statues d'un marbre étincelant pour commémorer l'âme des défunts." },
    {TR_BUILDING_LARGE_MAUSOLEUM_CONSTRUCTION_DESC, "Bâtir ce mausolée requiert des matériaux d'un entrepôt, des ouvriers d'un chantier, et des architectes de la guilde homonyme." },
    ...
    {TR_BUILDING_CITY_MINT_PHASE_1_TEXT, "Les ingénieurs établissent les fondations du bâtiment."},
    ...
    {TR_ACTION_TYPE_CAUSE_BLESSING, "Cause une bénédiction" },
    {TR_ACTION_TYPE_CAUSE_MINOR_CURSE, "Cause une malédiction mineure" },
    {TR_ACTION_TYPE_CAUSE_MAJOR_CURSE, "Cause une malédiction majeure" },
    ...
    {TR_CONFIG_USER_PATH_DEFAULT, "Défaut (répertoire d'installation de Caesar III, pas de sous-dossiers)" },
    {TR_CONFIG_USER_PATH_WITH_SUBDIRECTORIES, "répertoire d'installation de Caesar III, avec sous-dossiers" },
