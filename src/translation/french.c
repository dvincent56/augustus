...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_DEPOT_DESC, "Ce dépôt envoie des attelages de bœufs transférer des biens entre entrepôts ou greniers selon l'ordre défini. Les charrettes doivent retourner au dépôt après chaque livraison."},
    ...
    {TR_BUILDING_GRAND_TEMPLE_CONSTRUCTION_DESC, "Bâtir un temple monumental requiert des matériaux stockés dans un entrepôt, des ouvriers d'un camp de travail, et des architectes de la guilde homonyme."},
    ...
    {TR_BUILDING_LIGHTHOUSE_CONSTRUCTION_DESC, "Bâtir un phare requiert des matériaux stockés dans un entrepôt, des ouvriers d'un camp de travail, et des architectes de la guilde homonyme."},
    ...
    {TR_BUILDING_MONUMENT_CONSTRUCTION_DESC, "Bâtir ce monument requiert des matériaux stockés dans un entrepôt, des ouvriers d'un camp de travail, et des architectes de la guilde homonyme." },
    ...
    {TR_BUILDING_SMALL_TEMPLE_CONSTRUCTION_DESC, "Bâtir ce temple requiert des matériaux d'un entrepôt, des ouvriers d'un camp de travail, et des architectes de la guilde homonyme." },
    ...
    {TR_BUILDING_LARGE_MAUSOLEUM_CONSTRUCTION_DESC, "Bâtir ce mausolée requiert des matériaux d'un entrepôt, des ouvriers d'un camp de travail, et des architectes de la guilde homonyme." },
    ...
    {TR_EDITOR_CHECK_LOG_MESSAGE, "Veuillez consulter le fichier augustus-log.txt situé dans le dossier Augustus pour plus de détails."},
    ...
    {TR_EDITOR_SCENARIO_SELECT_INTRO, "Choisir intro de scénario"},
    {TR_EDITOR_SCENARIO_DESELECT_INTRO, "Retirer intro de scénario"},
    {TR_EDITOR_SCENARIO_SELECT_VICTORY, "Choisir le message de la victoire"},
    {TR_EDITOR_SCENARIO_DESELECT_VICTORY, "Supprimer le message de la"},
    {TR_EDITOR_CUSTOM_VARIABLES_TITLE, "Variables perso." },
    {TR_EDITOR_CUSTOM_VARIABLES_COUNT, "Variables possibles max." },
    {TR_EDITOR_GRID_OFFSET, " décalage" },
    ...
    {TR_PARAMETER_VALUE_MEDIA_TYPE_SPEECH, "Parole"},
    ...
    {TR_BUILDING_DEPOT_FEW_EMPLOYEES, "Avec quasiment aucun employé dans ce dépôt, nul ne se souvient quand fut dépêché son dernier attelage de bœufs." },
