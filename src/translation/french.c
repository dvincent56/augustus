...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_CARAVANSERAI_NEEDS_WORKERS, "Le Caravansérail manque de main-d'œuvre et ne peut pas satisfaire toutes les caravanes."},
    ...
    {TR_EDITOR_CITY_PREVIEW, "Aperçu icône de la cité: "},
    ...
    {TR_EDITOR_INVASION_DATE, "Date de l'invasion:"},
    {TR_EDITOR_INVASION_SIZE, "Taille de l'invasion:"},
    {TR_EDITOR_INVASION_ENEMY_TYPE, "Type d'ennemis:"},
