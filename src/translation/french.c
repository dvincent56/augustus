...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_SHOW_DESIRABILITY_RANGE, "Voir l'attrait des mausolées et nymphées lors du placement"},
    ...
    {TR_CONFIG_DRAW_CADUCEUS, "Afficher un caducée pour les menus de soins"},
};
