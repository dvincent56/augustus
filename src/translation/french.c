...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_DEPOT_DESC, "Ce dépôt envoie des charretiers transférer des biens entre les entrepôts et greniers selon leur numéro. Les charretiers doivent retourner au dépôt après chaque livraison."},
    ...
    {TR_BUILDING_TAVERN_DESC_3, "Cette taverne divertit ses clients tant que le vin coule à flots. Un approvisionnement en viande ou poisson augmenterait sa réputation." },
    {TR_BUILDING_TAVERN_DESC_4, "Le vin abondant et le fumet des victuailles attirent dans cette taverne une foule amatrice de jeux de hasard, de musique et de fête." },
    ...
    {TR_TOOLTIP_OVERLAY_TAVERN_4, "Une tavernière approvisionnée en vin et en viande ou poisson, est passée près de cette maison." },
    {TR_TOOLTIP_OVERLAY_TAVERN_5, "Une tavernière approvisionnée en vin, est passée récemment près de cette maison." },
    {TR_TOOLTIP_OVERLAY_TAVERN_6, "Une tavernière approvisionnée en vin et en viande ou poisson, est passée récemment près de cette maison. Que la fête commence !" },
    ...
    {TR_BUILDING_CITY_MINT_DESC_PALACE, "Puisque vous possédez un palais, quelques pièces sont ajoutées à vos fonds personnels."},
    ...
    {TR_BUILDING_DEPOT_NO_EMPLOYEES, "Ce dépôt n'a pas de main-d'œuvre. Des chats font la sieste dans les charrettes vides." },
    {TR_BUILDING_DEPOT_FEW_EMPLOYEES, "Avec quasiment aucun employé ici, nul ne se souvient quand ce dépôt a envoyé son dernier charretier." },
    {TR_BUILDING_DEPOT_SOME_EMPLOYEES, "Très peu d'employés travaillent dans ce dépôt. Cela prend une éternité pour transférer des biens." },
    ...
    {TR_BUILDING_SHRINE_DESC, "Les autels sont appréciés non seulement du voisinage mais aussi des dieux auxquels ils sont dédiés."},
