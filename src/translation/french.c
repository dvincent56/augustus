...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_DEFAULT_PLAYER_NAME, "Nom du joueur par défaut :"},
    ...
    {TR_BUILDING_WATCHTOWER_DESC, "Les archers de la tour guettent les envahisseurs, et des patrouilleurs arpentent les rues en contrebas." },
    ...
    {TR_EDITOR_UNABLE_TO_LOAD_CUSTOM_MESSAGES_TITLE, "Impossible de charger les messages personnalisés"},
    ...
    {TR_WINDOW_ORIGINAL_CAMPAIGN_DESC, "Campagne originelle de Caesar III de 1998, dans toute sa gloire d'antan."},
    ...
    {TR_CITY_MESSAGE_TEXT_CARAVANSERAI_COMPLETE, "Le Caravansérail est achevé. De nouveaux horizons commerciaux se profilent. Les caravanes des quatre coins du monde sont enthousiastes à l'idée de venir commercer dans votre cité."},
    ...
    {TR_TOOLTIP_BARRACKS_PRIORITY_TOWER, "Priorité d'affectation aux Tours"},
