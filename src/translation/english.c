...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_TOLLHOUSE_DESC, "The Curatorium maintains your highway network. While supplied with stone and sand, it halves the upfront cost of new highways and halves the monthly levies of all highway tiles. Requires a Senate to be built. Only one Curatorium can be constructed."},
    {TR_BUILDING_TOLLHOUSE_NO_EMPLOYEES, "This Curatorium has no employees. Highway maintenance is suspended."},
    {TR_BUILDING_TOLLHOUSE_NO_RESOURCES, "This Curatorium needs more stone and sand to maintain the highway network."},
    {TR_BUILDING_TOLLHOUSE_FUNCTIONAL, "The Curatorium is operating. Highway costs and levies are halved."},
    {TR_BUILDING_TOLLHOUSE_NOT_FUNCTIONAL, "The Curatorium is idle. Highway costs and levies are at full price."},
    ...
    {TR_WARNING_TOLLHOUSE_NEEDS_SENATE, "A Senate must be built first."},
