...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_SHOW_CONSTRUCTION_SIZE, "Show drag-able construction size"},
    ...
    {TR_CITY_MESSAGE_TEXT_GRAND_TEMPLE_COMPLETE, "Priests and worshipers flock to the new grand temple for the rites of dedication. Your people stand in awe of the majesty of your works, and your chosen deity showers you with favor."},
    ...
    {TR_CONFIG_SHOW_DESIRABILITY_RANGE, "Show desirability when building mausoleums and nymphaea"},
