...
static translation_string all_strings[] = {
    ...
    {TR_CITY_WARNING_WORKCAMP_NEEDED, "This building needs a working workcamp"},
    {TR_CITY_WARNING_BUILD_WORKCAMP, "Build a workcamp"},
    ...
    {TR_BUILDING_TOLLHOUSE, "Maintenance Station"},
    {TR_BUILDING_TOLLHOUSE_DESC, "The Maintenance Station maintains your highway network. While supplied with stone and sand by workcamp workers, it halves the upfront cost of new highways and halves the monthly levies of all highway tiles. Requires a Workcamp to be built. Only one Maintenance Station can be constructed."},
    {TR_BUILDING_TOLLHOUSE_NO_EMPLOYEES, "This Maintenance Station has no employees. Highway maintenance is suspended."},
    {TR_BUILDING_TOLLHOUSE_NO_RESOURCES, "This Maintenance Station needs more stone and sand to maintain the highway network."},
    {TR_BUILDING_TOLLHOUSE_FUNCTIONAL, "The Maintenance Station is operating. Highway costs and levies are halved."},
    {TR_BUILDING_TOLLHOUSE_NOT_FUNCTIONAL, "The Maintenance Station is idle. Highway costs and levies are at full price."},
    ...
    {TR_TOOLTIP_BUTTON_TOLLHOUSE, "Maintenance Station"},
    {TR_WARNING_TOLLHOUSE_NEEDS_SENATE, "A Workcamp must be built first."},
