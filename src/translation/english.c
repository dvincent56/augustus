...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_GRAND_TEMPLE_PHASE_3_TEXT, "Engineers are crafting the cella, the temple interior that will house the sacred images." },
    ...
    {TR_BUILDING_MONUMENT_CONSTRUCTION_DESC, "Construction of the monument will require resources stored in a warehouse, laborers from a work camp, and architects from an architects' guild." },
