...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_RANDOMISE_MUSIC, "Randomize city music"},
    ...
    {TR_BUILDING_CARAVANSERAI_FOOD_SHORTAGE, "The Caravanserai has employees and food, but the stocks are too low to supply all merchant caravans." },
    ...
    {TR_BUILDING_LIGHTHOUSE_BONUS_DESC, "Lighthouse is fully operational. The light atop this great tower guides ships from the far reaches of the world safely to your city. Fishing ships now move 10% faster, and sea storms last half as long." },
    {TR_BUILDING_LIGHTHOUSE_NO_TIMBER, "Lightkeepers are struggling to find the timber necessary to keep the flame alight. The ships approaching your shores strain to see the fading beacon."},
    ...
    {TR_WINDOW_FIGURE_TOURIST, "This traveler has spent: "},
    {TR_FIGURE_TYPE_TOURIST,  "Traveler"},
    ...
    {TR_CITY_WARNING_WORKCAMP_NEEDED, "This building needs a working work camp"},
    {TR_CITY_WARNING_BUILD_WORKCAMP, "Build a work camp"},
    ...
    {TR_BUILDING_HIGHWAY_STATION, "Highway station"},
    {TR_BUILDING_HIGHWAY_STATION_DESC, "The highway station houses skilled workers who construct and maintain the Roman highway network. A steady supply of stone and sand, dispatched by a work camp, will halve the cost of new highways and halve the monthly levies of all highways."},
    {TR_BUILDING_HIGHWAY_STATION_NO_EMPLOYEES, "This highway station has no employees. Highway maintenance is suspended."},
    {TR_BUILDING_HIGHWAY_STATION_NO_RESOURCES, "This highway station needs more stone and sand to maintain the highway network."},
    ...
    {TR_BUILDING_HIGHWAY_STATION_HIGHWAY_TILES, "Highways in the city:"},
    {TR_BUILDING_HIGHWAY_STATION_STONE_STOCK, "Stored stone,"},
    {TR_BUILDING_HIGHWAY_STATION_SAND_STOCK, "Stored sand,"},
    {TR_TOOLTIP_BUTTON_HIGHWAY_STATION, "Highway station"},
    {TR_WARNING_HIGHWAY_STATION_NEEDS_SENATE, "A work camp must be built first."},
    ...
    {TR_EDITOR_EMPIRE_TOOL, "Current empire tool: "},
    ...
    {TR_EDITOR_FAVOUR_IGNORED, "Favor lost if request ignored:"},
    ...
    {TR_CITY_PROPERTY_NONE, "None"},
    {TR_CITY_PROPERTY_DIFFICULTY, "Difficulty"},
    {TR_CITY_PROPERTY_MONEY, "City money"},
    {TR_CITY_PROPERTY_POPULATION, "Population"},
    {TR_CITY_PROPERTY_SAVINGS, "Personal savings"},
    {TR_CITY_PROPERTY_YEAR_FINANCE_BALANCE, "Yearly finance balance"},
    {TR_CITY_PROPERTY_RESOURCE_STOCK, "Resource stock"},
    {TR_CITY_PROPERTY_STATS_FAVOR, "Favor"},
    {TR_CITY_PROPERTY_STATS_PROSPERITY, "Prosperity"},
    {TR_CITY_PROPERTY_STATS_CULTURE, "Culture"},
    {TR_CITY_PROPERTY_STATS_PEACE, "Peace"},
    {TR_CITY_PROPERTY_STATS_CITY_HEALTH, "City health"},
    {TR_CITY_PROPERTY_SERVICE_COVERAGE, "Service coverage"},
    {TR_CITY_PROPERTY_POPS_UNEMPLOYMENT, "Unemployment"},
    {TR_CITY_PROPERTY_POPS_HOUSING_TYPE, "Population by housing type"},
    {TR_CITY_PROPERTY_POPS_BY_AGE, "Population by age"},
    {TR_CITY_PROPERTY_ROME_WAGES, "Rome wages"},
    {TR_CITY_PROPERTY_CITY_WAGES, "City wages"},
    {TR_CITY_PROPERTY_BUILDING_COUNT, "Building count"},
    {TR_CITY_PROPERTY_TROOPS_COUNT_PLAYER, "Player troops"},
    {TR_CITY_PROPERTY_TROOPS_COUNT_ENEMY, "Enemy troops"},
    {TR_CITY_PROPERTY_TERRAIN_COUNT_TILES, "Terrain tiles"},
    {TR_CITY_PROPERTY_TROOPS_MELEE, "Melee troops"},
    {TR_CITY_PROPERTY_TROOPS_RANGED, "Ranged troops"},
    {TR_CITY_PROPERTY_TROOPS_MOUNTED, "Mounted troops"},
    {TR_CITY_PROPERTY_ALL, "All"},
    {TR_CITY_PROPERTY_ACTIVE_ONLY, "Active only"},
    {TR_CITY_PROPERTY_COVERAGE_THEATRE, "Theater coverage"},
    {TR_CITY_PROPERTY_COVERAGE_ARENA, "Arena coverage"},
    {TR_CITY_PROPERTY_COVERAGE_AMPHITHEATRE, "Amphitheater coverage"},
    ...
    {TR_WARNING_DEPOT_RECALL_ALL, "All Depot cart pushers recalled!"},
    ...
    {TR_MESSAGE_PROMOTE_RANK_PREFIX, "Great news, governor! Impressed by your performance, Caesar has promoted you to the rank of "},
    {TR_MESSAGE_DEMOTE_RANK_PREFIX, "Grave news, governor! Displeased with your performance, Caesar has demoted you to the rank of "},
    {TR_MESSAGE_PROMOTE_RANK_SUFFIX, ". It comes with a pay rise, well done!"},
    {TR_MESSAGE_DEMOTE_RANK_SUFFIX, ". Your salary has been cut!"},
    {TR_PARAMETER_TYPE_RANK, "Governor rank"},
    {TR_RANK_PROMOTE, "Promote (+1 rank)"},
    {TR_RANK_DEMOTE, "Demote (-1 rank)"},
    {TR_RANK_CITIZEN, "Citizen"},
    {TR_RANK_CLERK, "Clerk"},
    {TR_RANK_ENGINEER, "Engineer"},
    {TR_RANK_ARCHITECT, "Architect"},
    {TR_RANK_QUAESTOR, "Quaestor"},
    {TR_RANK_PROCURATOR, "Procurator"},
    ...
    {TR_EMPIRE_ORNAMENT_STONEHENGE, "The Stonehenge"},
    {TR_EMPIRE_ORNAMENT_GALLIC_WHEAT, "Gallic Wheat"},
    {TR_EMPIRE_ORNAMENT_THE_PYRENEES, "The Pyrenees"},
    {TR_EMPIRE_ORNAMENT_IBERIAN_AQUEDUCT, "Iberian Aqueduct"},
    {TR_EMPIRE_ORNAMENT_TRIUMPHAL_ARCH, "Triumphal Arch"},
    {TR_EMPIRE_ORNAMENT_WEST_DESERT_WHEAT, "West Desert Wheat"},
    {TR_EMPIRE_ORNAMENT_LIGHTHOUSE_ALEXANDRIA, "Lighthouse of Alexandria"},
    {TR_EMPIRE_ORNAMENT_WEST_DESERT_PALMS, "West Desert Palm Trees"},
    {TR_EMPIRE_ORNAMENT_TRADE_SHIP, "Trade Ship"},
    {TR_EMPIRE_ORNAMENT_WATERSIDE_PALMS, "Waterside Palm Trees"},
    {TR_EMPIRE_ORNAMENT_THE_COLOSSEUM, "The Colosseum"},
    {TR_EMPIRE_ORNAMENT_THE_ALPS, "The Alps"},
    {TR_EMPIRE_ORNAMENT_ROMAN_TREE, "Roman Tree"},
    {TR_EMPIRE_ORNAMENT_GREEK_MOUNTAINS, "Greek Mountain Range"},
    {TR_EMPIRE_ORNAMENT_THE_PARTHENON, "The Parthenon"},
    {TR_EMPIRE_ORNAMENT_THE_PYRAMIDS, "The Pyramids"},
    {TR_EMPIRE_ORNAMENT_HAGIA_SOPHIA, "The Hagia Sophia"},
    {TR_EMPIRE_ORNAMENT_EAST_DESERT_PALMS, "East Desert Palm Trees"},
    {TR_EMPIRE_ORNAMENT_EAST_DESERT_WHEAT, "East Desert Wheat"},
    {TR_EMPIRE_ORNAMENT_TRADE_CAMEL, "Trade Camel"},
    ...
    {TR_CONFIG_HEADER_SAND, "Sandstorms" },
    {TR_CONFIG_HEADER_EMPIRE_EDITOR, "Empire Editor" },
    ...
    {TR_CONFIG_WT_RAIN_SPEED, "Raindrop speed" },
    {TR_CONFIG_WT_RAIN_LENGTH, "Raindrop size" },
    ...
    {TR_CONFIG_WT_SANDSTORM_SPEED, "Sand speed" },
    {TR_CONFIG_WT_SANDSTORM_SIZE, "Sand size" },
    {TR_CONFIG_WT_SNOW_SPEED, "Snowflake speed" },
    {TR_CONFIG_WT_SNOWFLAKE_SIZE, "Snowflake size" },
    {TR_CONFIG_WT_SIZE_MINIMUM, "Minimum"},
    {TR_CONFIG_WT_SIZE_SMALL, "Small"},
    {TR_CONFIG_WT_SIZE_REGULAR, "Regular"},
    {TR_CONFIG_WT_SIZE_LARGE, "Large"},
    {TR_CONFIG_WT_SIZE_MAXIMUM, "Maximum" },
    {TR_CONFIG_WT_SPEED_SLOW, "Slow" },
    {TR_CONFIG_WT_SPEED_FAST, "Fast" },
    ...
    {TR_ADVISOR_CHIEF_WELL_WATER, "Most of your people have to receive their water from wells."},
