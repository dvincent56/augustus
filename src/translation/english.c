...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_HIGHWAY_STATION_DESC, "The Highway Station maintains your highway network. While supplied with stone and sand by workcamp workers, it halves the upfront cost of new highways and halves the monthly levies of all highway. Requires a Workcamp to be built. Only one Highway Station can be constructed."},
    ...
    {TR_BUILDING_HIGHWAY_STATION_HIGHWAY_TILES, "Highway in city:"},
    ...
    {TR_WARNING_HIGHWAY_STATION_NEEDS_SENATE, "A Workcamp must be built first."},
