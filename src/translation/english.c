...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_TOLLHOUSE, "Tollhouse"},
    {TR_BUILDING_TOLLHOUSE_DESC, "The Tollhouse maintains your highway network. While supplied with stone and sand, it halves the upfront cost of new highways and halves the monthly levies of all highway tiles. Requires a Senate to be built. Only one Tollhouse can be constructed."},
    {TR_BUILDING_TOLLHOUSE_NO_EMPLOYEES, "This tollhouse has no employees. Highway maintenance is suspended."},
