...
enum {
    ...
    TERRAIN_RUBBLE | TERRAIN_WALL_OR_GATEHOUSE | TERRAIN_HIGHWAY | TERRAIN_MARSHLAND,
    ...
    TERRAIN_WALL_OR_GATEHOUSE | TERRAIN_HIGHWAY | TERRAIN_MARSHLAND,
