...
static building_levy_for_type building_levies[] = {
    ...
    {BUILDING_SMALL_MAUSOLEUM, TEMPLE_LEVY_MONTHLY},
    {BUILDING_LARGE_MAUSOLEUM, TEMPLE_LEVY_MONTHLY},
    {BUILDING_NYMPHAEUM, TEMPLE_LEVY_MONTHLY},
};
...
static void pay_monthly_building_levies(void) {
    ...
    for (int i = 1; i < building_count(); i++) {
        ...
        if (b->state == BUILDING_STATE_IN_USE && building_get_levy(b) && !b->prev_part_building_id) {
